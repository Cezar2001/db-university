...
SELECT `students`.`name`, `students`.`surname`, `students`.`id`, `departments`.`name`,
...
SELECT `degrees`.`id`, `degrees`.`name`, `courses`.`id`, `courses`.`name`, `courses`.`year`, 
...
SELECT `departments`.`name`, `teachers`.`id`, `teachers`.`name`, 
		`teachers`.`surname`
FROM `departments`
JOIN `degrees`
	ON `degrees`.`department_id` = `departments`.`id`
